...
let_coma_list:
			OBJECTID ':' TYPEID IN expr %prec LET
				{ $$ = let($1, $3, no_expr(), $5); }
			| OBJECTID ':' TYPEID ASSIGN expr IN expr %prec LET
				{ $$ = let($1, $3, $5, $7); }
			| OBJECTID ':' TYPEID ',' let_coma_list
				{ $$ = let($1, $3, no_expr(), $5); }
			| OBJECTID ':' TYPEID ASSIGN expr ',' let_coma_list
				{ $$ = let($1, $3, $5, $7); }
			| error ',' let_coma_list
				{ yyerrok; };
