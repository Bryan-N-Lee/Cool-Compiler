...
// overwrite macros to use proper code method
#undef Expression_EXTRAS
#define Expression_EXTRAS                    \
Symbol type;                                 \
Symbol get_type() { return type; }           \
Expression set_type(Symbol s) { type = s; return this; } \
virtual void code(Environment&, ostream&) = 0; \
...
virtual bool is_never_null() = 0;\
virtual bool is_unique() = 0;

#undef Expression_SHARED_EXTRAS
#define Expression_SHARED_EXTRAS           \
virtual void code(Environment&, ostream&); 			   \
virtual int numLocals();\
virtual bool is_never_null();\
...
public:
   ...
   virtual method_class* isMethod() = 0;
   virtual attr_class* isAttr() = 0;
   virtual int numLocals() = 0;
...
public:
   ...
   virtual void code(Environment&, CgenNodeP cn, int exit_label, int offsetFromFP, bool guaranteed, ostream&) = 0;
   virtual int numLocals() = 0;
   virtual bool is_never_null() = 0;
   virtual bool is_unique() = 0;
...
public:
   method_class(Symbol a1, Formals a2, Symbol a3, Expression a4) {
      ...
      return_type = a3;
      expr = a4;
      isFinal = true; // initial assumption
   }
   Feature copy_Feature();
   void dump(ostream& stream, int n);
   
   void code(Environment& env, ostream &s);
   virtual method_class* isMethod() { return this; }
   virtual attr_class* isAttr() { return NULL; }
   virtual int numLocals();
...
public:
   ...
   virtual method_class* isMethod() { return NULL; }
   virtual attr_class* isAttr() { return this; }
   virtual int numLocals();
...
public:
   ...
   Case copy_Case();
   void dump(ostream& stream, int n);
   virtual void code(Environment&, CgenNodeP cn, int exitLabel, int offsetFromFP, bool guaranteed, ostream&);
   virtual int numLocals();
...
public:
    ...
    static_dispatch_class(dispatch_class* d, Symbol t) {
        expr = d->expr;
        type_name = t;
        name = d->name;
        actual = d->actual;
...
public:
   ...
   virtual bool is_bool_const() { return true; }
